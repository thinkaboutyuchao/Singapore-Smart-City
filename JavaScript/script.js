...
document.getElementById("railLayer").addEventListener("change", function(e) {
    ...
    if (visible) {
        ...
        if (!railGeoJsonLoaded) {
            map.data.loadGeoJson("https://thinkaboutyuchao.github.io/Singapore-Smart-City/Data/RailStations/RailStations.geojson", null, function(features) {
...
document.getElementById("networkLayer").addEventListener("change", function (e) {
    ...
    if (visible) {
        ...
        if (!networkGeoJsonLoaded) {
            const networkGeoJsonUrl = new URL("https://thinkaboutyuchao.github.io/Singapore-Smart-City/Data/NetWork/NetWork.geojson", window.location.href).href;
