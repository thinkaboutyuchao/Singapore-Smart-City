...
fetch("https://internetgisapi-e6aabmhqezhgf3b9.eastasia-01.azurewebsites.net/weather")
  ...
  .then(data => {
    ...
    if (forecastText.includes("Cloudy")) {
      imageHtml = `<img src="https://raw.githubusercontent.com/thinkaboutyuchao/Singapore-Smart-City/refs/heads/main/Data/Weather/Cloudy.gif" alt="Cloudy Weather" style="width:240px;height:200px;">`;
    }else if(forecastText.includes("Showers") || forecastText.includes("Rain")){
      imageHtml = `<img src="https://raw.githubusercontent.com/thinkaboutyuchao/Singapore-Smart-City/refs/heads/main/Data/Weather/Showers.gif" alt="Cloudy Weather" style="width:240px;height:200px;">`;
    }else{
      imageHtml = `<img src="https://raw.githubusercontent.com/thinkaboutyuchao/Singapore-Smart-City/refs/heads/main/Data/Weather/Sun.gif" alt="Cloudy Weather" style="width:240px;height:200px;">`;
    }
    // 获取天气信息面板，并更新内容
