...
function updateLegend() {
  ...
  if (document.getElementById('taxiLayer').checked) {
    ...
    legendPanel.innerHTML += `
      <div class="legend-item">
        <img src="https://thinkaboutyuchao.github.io/Singapore-Smart-City/Data/Taxi/Taxi.png" alt="Taxi Icon" style="width:20px;height:20px;vertical-align:middle;">
  ...
  if (document.getElementById('trafficAccidentLayer').checked) {
    ...
    legendPanel.innerHTML += `
      <div class="legend-item">
        <img src="https://thinkaboutyuchao.github.io/Singapore-Smart-City/Data/Incidents/incidents.png" alt="Traffic Accident Icon" style="width:20px;height:20px;vertical-align:middle;">
  ...
  if (document.getElementById('cameraLayer').checked) {
    ...
    legendPanel.innerHTML += `
      <div class="legend-item">
        <img src="https://thinkaboutyuchao.github.io/Singapore-Smart-City/Data/Cameras/camera.png" alt="Camera Icon" style="width:20px;height:20px;vertical-align:middle;">
