...
function updateLegend() {
  ...
  if (document.getElementById('taxiLayer').checked) {
    ...
    legendPanel.innerHTML += `
      <div class="legend-item">
        <img src="https://raw.githubusercontent.com/thinkaboutyuchao/Singapore-Smart-City/refs/heads/main/Data/Taxi/Taxi.png" alt="Taxi Icon" style="width:20px;height:20px;vertical-align:middle;">
  ...
  if (document.getElementById('trafficAccidentLayer').checked) {
    ...
    legendPanel.innerHTML += `
      <div class="legend-item">
        <img src="https://raw.githubusercontent.com/thinkaboutyuchao/Singapore-Smart-City/refs/heads/main/Data/Incidents/incidents.png" alt="Traffic Accident Icon" style="width:20px;height:20px;vertical-align:middle;">
  ...
  if (document.getElementById('cameraLayer').checked) {
    ...
    legendPanel.innerHTML += `
      <div class="legend-item">
        <img src="https://raw.githubusercontent.com/thinkaboutyuchao/Singapore-Smart-City/refs/heads/main/Data/Cameras/camera.png" alt="Camera Icon" style="width:20px;height:20px;vertical-align:middle;">
